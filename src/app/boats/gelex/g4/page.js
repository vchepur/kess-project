...
const images = [
    { src: '/boats/gelex/g4/g4-1.png', alt: 'Photo 1' },
    { src: '/boats/gelex/g4/g4-2.png', alt: 'Photo 2' },
    { src: '/boats/gelex/g4/g4-3.png', alt: 'Photo 3' },
    { src: '/boats/gelex/g4/g4-4.png', alt: 'Photo 4' },
    { src: '/boats/gelex/g4/g4-5.png', alt: 'Photo 5' },
];
...
export default function BoatPage() {
    ...
    const boatConfigSteps = [
        ...
        },
        {
            title: 'Wählen Sie den Motor',
            options: [
                { name: 'REMOTE CONSOLE WITH WINDSHIELD AND SOFA IN THE AFT SECTION', price: 500, image: '/test/1.png' },
                { name: 'Basis B', price: 700, image: '/test/2.png' },
                { name: 'Basis C', price: 1000, image: '/test/3.png' },
                { name: 'Basis D', price: 1200, image: '/test/1.png' },
                { name: 'Basis E', price: 1500, image: '/test/2.png' },
        ...
        {
            title: 'Inneneinrichtung', // Текстовый выбор без изображений
            options: [
                { name: 'Option 1ыфвыфввыфвфвыфвыфывввыв', price: 300 },
                { name: 'Option 2', price: 450 },
                { name: 'Option 3', price: 600 },
                { name: 'Option 4', price: 750 },
            ],
        },
        {
            title: 'Elektronikpaket', // Еще один текстовый выбор без изображений
            options: [
                { name: 'Option 1', price: 200 },
                { name: 'Option 2', price: 350 },
                { name: 'Option 3', price: 500 },
                { name: 'Option 4', price: 650 },
            ],
        },
    ];
